...
== Perform (execute) an ImportDefinition:
 ...
 == Data Extension Object example:
    ...
    data_extension.Properties << ExactTargetSDK::Property.new("Name" => "gender",     "Value" => "male")      data_extension.Properties << ExactTargetSDK::Property.new("Name" => "birthdate",  "Value" => "12/31/1999")
